...
require (
	github.com/ledgerwatch/erigon-lib v0.0.0-20230811232333-7866674ce037
...
replace github.com/ledgerwatch/erigon-lib => github.com/etccooperative/erigon-lib v0.0.0-20230812001432-0570728c4698
